...
export function LatestNewsSection() {
  return <section className="py-8 sm:py-12 bg-gray-50/50">
      <div className="container px-4">
        {/* Section Header */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8">
          <div className="text-center sm:text-left mb-4 sm:mb-0">
            <h2 className="text-foreground mb-2 text-2xl sm:text-3xl md:text-4xl font-bold">
              Latest News
            </h2>
            <p className="text-muted-foreground text-sm sm:text-base">Insights into the Australian new development & real estate market</p>
          </div>
          <Button variant="ghost" className="text-primary hover:text-primary/90 self-center sm:self-auto text-sm sm:text-base">
            Browse all news
          ...
          {newsArticles.map(article => <Card key={article.id} className="group cursor-pointer hover:shadow-xl transition-all duration-300 border-0 shadow-sm hover:-translate-y-1">
              <CardContent className="p-0">
                ...
                <div className="relative overflow-hidden rounded-t-lg">
                  <img src={article.image} alt={article.headline} className="w-full h-40 sm:h-44 md:h-48 object-cover group-hover:scale-110 transition-transform duration-300" />
                </div>
                ...
                <div className="p-3 sm:p-4">
                  ...
                  <h3 className="text-sm sm:text-base leading-tight text-foreground group-hover:text-primary transition-colors line-clamp-3 font-semibold">
                    {article.headline}
                  </h3>
