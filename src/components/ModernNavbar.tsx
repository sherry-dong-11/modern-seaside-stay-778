  ...
  return (
    ...
    >
      <nav className="container flex justify-between items-center relative z-50">
        ...
        {/* Desktop Navigation */}
        <motion.ul 
          className="hidden lg:flex space-x-4 items-center whitespace-nowrap"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          >
            <motion.button 
              className={cn(
                ...
                scrolled ? "text-foreground hover:text-primary" : "text-slate-900 hover:text-primary"
              )}
        ...
        >
          <div className={cn("transition-colors", scrolled ? "text-foreground" : "text-slate-900")}>
            <LanguageSelector />
          </div>
          <div className={cn("transition-colors", scrolled ? "text-foreground" : "text-slate-900")}>
            <ThemeToggle />
