          ...
          <FadeInSection>
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div className="order-1 lg:order-2">
                <div className="bg-background/95 backdrop-blur-sm rounded-xl shadow-2xl border border-primary/10 overflow-hidden group hover:shadow-2xl hover:scale-[1.02] transition-all duration-500 p-6">
