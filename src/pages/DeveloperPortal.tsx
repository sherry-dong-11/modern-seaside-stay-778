          ...
          <FadeInSection>
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div className="order-1 lg:order-2">
                <div className="bg-background rounded-xl shadow-lg p-6 border animate-fade-in transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:bg-gradient-to-br hover:from-background hover:to-muted/20 hover:border-primary/20 group">
