      ...
      <section className="bg-gradient-to-br from-primary-50/40 to-accent/30 py-0 border-y border-primary-200/40 shadow-sm">
        <div className="container mx-auto px-[15px] py-[8px]">
          <FadeInSection className="text-center mb-16">
            <h2 className="font-bold mb-6 text-left text-4xl text-orange-600 py-[9px] md:text-5xl">Our Services</h2>
          </FadeInSection>
          <FadeInSection>
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20 py-0">
              {/* Left Side - Text Content */}
              <div className="order-2 lg:order-1">
                <h2 className="text-2xl font-bold mb-6 md:text-3xl text-slate-800">Real-Time Reporting</h2>
              ...
              <div className="order-1 lg:order-2">
                <div className="bg-background/95 backdrop-blur-sm rounded-xl shadow-2xl border border-primary/10 animate-fade-in overflow-hidden w-full max-w-full p-3 sm:p-4 lg:p-6 py-[5px]">
