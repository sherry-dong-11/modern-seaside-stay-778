...
import { Code, Database, Zap, Shield, Globe, GitBranch, Terminal, Book, Download, ExternalLink, Cpu, Network, Lock, Check } from "lucide-react";
import ModernNavbar from "@/components/ModernNavbar";
import ModernFooter from "@/components/ModernFooter";
import FadeInSection from "@/components/FadeInSection";
import { Link } from "react-router-dom";
import listingsImage from "@/assets/developer-portal-listings.jpg";
import analyticsImage from "@/assets/developer-portal-analytics.jpg";
import leadsImage from "@/assets/developer-portal-leads.jpg";
export default function DeveloperPortal() {
  ...
  const services = [{
    image: listingsImage,
    title: "We feature every new development in Australia",
    description: "We track and showcase every new residential development in Australia",
    features: [
      "100% of our audience is specifically looking for new apartments & townhouses",
      "Dedicated platform for off-the-plan properties only",
      "Comprehensive coverage across all Australian markets"
    ]
  }, {
    image: analyticsImage,
    title: "We tell the story behind your development",
    description: "Connect with our team of journalists to educate buyers about your project",
    features: [
      "Professional content creation and storytelling services",
      "Expert journalists who understand property development",
      "Compelling narratives that drive buyer engagement"
    ]
  }, {
    image: leadsImage,
    title: "Only pay when we connect you to qualified leads",
    description: "Lead qualification is about respecting the sales teams time",
    features: [
      "SMS verified contact details for every lead",
      "Pre-qualified buyers with genuine purchase intent",
      "Pay-per-lead model - no upfront costs"
    ]
  }];
  const solutions = [{
    icon: Terminal,
        ...
        <div className="container mx-auto px-4">
          <FadeInSection className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              ...
              off-the-plan property marketplace
            </h2>
          </FadeInSection>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <FadeInSection key={index} delay={index * 0.1}>
                <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 group border-0 bg-muted/30">
