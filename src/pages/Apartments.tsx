          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in">
              ...
              <div>
                ...
                <Select value={capacityFilter} onValueChange={setCapacityFilter} className="bg-white">
              ...
              <div>
                ...
                <Select value={locationFilter} onValueChange={setLocationFilter}>
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder={t.apartments.filters.location} className="bg-white rounded-sm text-gray-800" />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Slider defaultValue={[100, 350]} min={100} max={350} step={10} value={priceRange} onValueChange={setPriceRange} className="my-4" />
              </div>
            </div>
