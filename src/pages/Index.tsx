      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          y: scrollY * 0.5
            ...
            <motion.img src={heroImage} alt="Cozy room interior" className="w-full h-full object-cover scale-110" initial={{
            scale: 1.2,
            opacity: 0
          }} animate={{
            scale: 1.1,
            ...
            <motion.div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/60 to-black/80" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
          ...
          <motion.div className="container relative z-10 text-center text-white">
            <div className="max-w-4xl mx-auto">
              ...
              <motion.h1 className="text-6xl md:text-7xl font-bold mb-8 leading-tight text-white" initial={{
              opacity: 0,
              y: 50
            }} animate={{
              opacity: 1,
              ...
              ease: [0.25, 0.46, 0.45, 0.94]
                ...
                Find Your Perfect
                <motion.span className="text-gradient bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent block" initial={{
                opacity: 0,
                scale: 0.8
              }} animate={{
                opacity: 1,
              ...
              {/* Enhanced Search Bar */}
              <motion.div className="max-w-2xl mx-auto mb-12" initial={{
              opacity: 0,
              y: 30
            }} animate={{
              opacity: 1,
              ...
              ease: [0.25, 0.46, 0.45, 0.94]
                ...
                <motion.div className="flex flex-col sm:flex-row gap-4 p-4 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20" whileHover={{
                scale: 1.02,
          ...
          <motion.div className="absolute bottom-8 left-0 right-0 z-10" initial={{
          opacity: 0,
          y: 50
        }} animate={{
          opacity: 1,
          ...
          delay: 1.8
            ...
            <div className="container">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                {stats.map((stat, index) => <motion.div key={index} className="glass-card p-6 text-center text-white rounded-2xl hover:bg-white/20 transition-all duration-300" initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
        ...
        <MotionWrapper animation="fadeInUp" className="relative bg-gradient-to-br from-primary-500 to-primary-600 text-white overflow-hidden section-sm">
          <motion.div className="container relative z-10" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} viewport={{
          ...
          duration: 0.8
            ...
            <div className="text-center max-w-3xl mx-auto">
              <motion.h2 className="text-5xl font-bold mb-8" initial={{
              opacity: 0,
              y: 30
            }} whileInView={{
              opacity: 1,
              ...
              <motion.div className="flex flex-col sm:flex-row gap-6 justify-center mb-8" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
              ...
              <motion.div className="flex flex-wrap items-center justify-center gap-6 text-sm text-white/90" initial={{
              opacity: 0
            }} whileInView={{
              opacity: 1
            }} viewport={{
              ...
              delay: 0.6
                ...
                {["No fees for buyers", "Expert guidance", "Verified properties"].map((text, index) => <motion.div key={text} className="flex items-center" initial={{
                opacity: 0,
                x: -20
              }} whileInView={{
                opacity: 1,
          ...
          <motion.div className="absolute top-0 right-0 w-1/2 h-full opacity-20" animate={{
          scale: [1, 1.1, 1],
          rotate: [0, 5, 0]
        }} transition={{
          duration: 20,
