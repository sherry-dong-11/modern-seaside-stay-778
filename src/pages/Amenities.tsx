...
import { Heart, Dumbbell, Waves, Activity, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Ship, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      ...
      entertainment: [<Ship key={0} />, <Users key={1} />, <Music key={2} />, <BookOpen key={3} />]
    };
